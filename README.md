...
* **🖥️ Certified Hardware Telemetry & Device Management:** Full client table with filters by band (**2.4 GHz, 5 GHz, 6 GHz, Wired Ethernet**), connected mesh node, Wi-Fi channel, RSSI signal strength (dBm), negotiated physical PHY rate, and **Static IP vs Dynamic DHCP indicators**.
...
* **🖥️ Telemetria Hardware Certificata & Gestione Dispositivi:** Tabella completa con filtri per frequenza (**2.4 GHz, 5 GHz, 6 GHz, Cablato Ethernet**), canale Wi-Fi, nodo eero collegato, potenza del segnale RSSI (dBm), velocità di link PHY negoziata e **indicatori visivi IP Statico vs DHCP**.
