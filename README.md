...
* **📖 Manuale Utente Integrato & Changelog:** Sezione di documentazione navigabile con ricerca istantanea full-text, tooltip contestuali e visualizzatore Changelog interattivo in-app (v1.01.00).
...
* **📄 Licenza Open Source:** Rilasciato sotto licenza permissiva **MIT**.
