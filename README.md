...
* **📖 Manuale Utente Integrato & Changelog:** Sezione di documentazione navigabile con ricerca istantanea full-text, tooltip contestuali e visualizzatore Changelog interattivo in-app (v1.00.06).
