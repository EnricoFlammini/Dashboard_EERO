...
async def get_changelog():
    ...
    for p in possible_paths:
        if p.exists():
            try:
                ...
                return {"status": "success", "version": "1.00.06", "content": content}
    ...
    return {
        "status": "success",
        "version": "1.00.06",
        "content": "# Changelog v1.00.06\n\n- Supporto per assegnazione IP corrente e riassegnazione prenotazioni tra schede di rete dello stesso terminale.\n- Risoluzione automatica vecchie prenotazioni su Cloud eero."
    }
